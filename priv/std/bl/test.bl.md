...
**`--shared`.** The old behavior: every file runs in this image, one after
another. Reach for it when a suite genuinely needs a shared world — and expect
the failure modes isolation exists to prevent.
